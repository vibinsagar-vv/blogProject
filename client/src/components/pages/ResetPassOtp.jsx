...
export default function ResetPassOtp({length=4}) {
   ...
   const handlechnage=(index,e)=>{
    ...
    const handlesubmit=async(e)=>{
            try{
                ...
                const resData =await AXIOS.post('http://localhost:7800/user/newPassword',{userotp:newotp,token:localStorage.getItem('token'),VerifyOtp:localStorage.getItem('verification')})
