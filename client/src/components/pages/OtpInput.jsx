   ...
   const handlechnage=(index,e)=>{
    ...
    const handlesubmit=async(e)=>{
            try{
                ...
                const resData =await AXIOS.post('http://localhost:7800/user/sign-up',{userotp:newotp,token:localStorage.getItem('token'),VerifyOtp:localStorage.getItem('verification')})
